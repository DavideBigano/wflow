...
// calls react-devtools-core at import time) whenever it's reached. Stub the
// target out so it's never bundled or evaluated, regardless of dead-code
// elimination of the `DEV === 'true'` guard around it.
function stubInkDevtools(): Plugin {
  return {
    ...
    resolveId(source, importer) {
      ...
      if (source.endsWith("devtools.js") && importerPosix.includes("/ink/build/")) {
